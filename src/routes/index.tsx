...
const PayrollItem = React.lazy(() => import("../pages/AssignedTask/PayrollItems"));
...
const authProtectedRoutes = [
    assignTaskRoutes, // Add assignTaskRoutes here
    dashboardRoutes,
    ...appRoutes,
    extrapagesRoutes,
    uiRoutes,
